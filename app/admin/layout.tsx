...
const navigation = [
  ...
  { name: "AI Training", href: "/admin/ai-training", icon: Brain },
  { name: "AI Settings", href: "/admin/ai-settings", icon: Brain },
  { name: "AI Feedback", href: "/admin/ai-feedback", icon: Brain },
  { name: "AI Moderation", href: "/admin/ai-moderation", icon: Shield },
  { name: "Cancellations", href: "/admin/cancellations", icon: AlertCircle },
      ...
      >
        <div className="flex h-16 items-center justify-between px-4 border-b">
          <Link href="/admin" className="flex items-center space-x-2">
            ...
            <span className="text-xl font-bold">Sponza Admin</span>
          </Link>
          <Button
            variant="ghost"
            size="icon"
