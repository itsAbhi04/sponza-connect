...
const navigation = [
  ...
  { name: "Wallet", href: "/dashboard/brand/wallet", icon: DollarSign },
]
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      >
        <div className="flex h-16 items-center justify-between px-4 border-b">
          <Link href="/dashboard/brand" className="flex items-center space-x-2">
                ...
                <DropdownMenuContent className="w-56" align="end" forceMount>
                  <DropdownMenuLabel className="font-normal">
                    <div className="flex flex-col space-y-1">
                      <p className="text-sm font-medium leading-none">Brand Account</p>
                      <p className="text-xs leading-none text-muted-foreground">brand@example.com</p>
                    </div>
                  </DropdownMenuLabel>
                  <DropdownMenuSeparator />
